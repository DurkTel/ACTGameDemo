...
public class DebugHelper : MonoBehaviour
{
    public void OnDrawGizmos()
    {
        ...
        count = lineGizmos.Count;
        for (int i = 0; i < count; i++)
        {
            Line line = lineGizmos.Dequeue();
    ...
    private Queue<Line> lineGizmos = new Queue<Line>();
    public void DrawLine(Vector3 form, Vector3 to, Color color, float duration = 0)
    {
        Line line = new Line();
        line.form = form;
        line.to = to;
